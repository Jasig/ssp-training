...
AS
	...
	--End Delete   
	 ...
	 INSERT INTO person(id, first_name, middle_name, last_name, birth_date, primary_email_address,            secondary_email_address, username, home_phone, work_phone, cell_phone, address_line_1, address_line_2, city, state, zip_code, photo_url, school_id, enabled, created_date, modified_date, created_by,modified_by, object_status, person_demographics_id, person_education_goal_id, person_education_plan_id, coach_id, ability_to_benefit, 
         ...
         VALUES (@UUID, @FIRSTNAME, '', @LASTNAME, '1968-01-04', 'demo@trainingssp.com', 'demo2@trainingssp.com', @USERNAME,'(555) 555-5555', '(777) 777-7777', '(888) 888-8888','123 W. Demo St.', 'Apt. 555', 'Phoenix', 'AZ','55555', NULL, @USERNAME, 1, '2010-08-20', '2010-08-20','58ba5ee3-734e-4ae9-b9c5-943774b4de41','58ba5ee3-734e-4ae9-b9c5-943774b4de41', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'DemoCounty', 'user', NULL, NULL);

...
INSERT INTO person_demographics(
    ...
    VALUES ('$(TASKID1)', '$(YEAR3)-09-13 09:22:00.092', '$(YEAR3)-09-13 09:22:00.092', '$(COACHID)', '$(COACHID)', '1',0, 0, 0, 0, 'US', 'Good', 'US', 0, null, null, null, null, null, 'M', 'c1d6598e-622d-428c-b7c2-1c4283d73126', 'ff149156-a02f-4e9d-bfb2-ef9dfb32eef2', '53c5efe6-c149-45d3-a719-6c8f1ac2e056', null, null, null, null, null);
...
INSERT INTO person_education_goal(
    ...
    VALUES ('$(TASKID1)', '$(YEAR3)-09-13 09:22:00.092', '$(YEAR3)-09-13 09:22:00.092', '$(COACHID)', '$(COACHID)', '1',
            null, null, 0, null, null, null, 0, 0, 0, 0, null, null, null);
...
VALUES ((SELECT NEWID()), (SELECT first_name FROM external_person WHERE school_id = '$(NEWSTUDENT1)'), 
	    ...
	    'demo@trainingssp.com', '', '$(NEWSTUDENT1)','(555) 555-5555', '', '','123 W. Demo St.', 'Apt. 555', 'Phoenix', 'AZ','55555', NULL, '$(NEWSTUDENT1)',1, '$(YEAR2)-08-20', '$(YEAR2)-08-20','$(COACHID)','$(COACHID)', '1', '$(TASKID1)', '$(TASKID1)', '$(TASKID1)', 'Student is good at x, y, and z.', '$(COACHID)', 1, 'SP$(YEAR3)', '$(YEAR3)', '$(YEAR3)-09-10 09:22:00.091', '0a640a2a-409d-1271-8140-d0afceae00f1', '$(YEAR3)-09-13 09:22:00.091', null,'$(YEAR3)', 'SP$(YEAR3)', 0, 0, '', '', '', '', '', '', '$(TASKID1)', 'Y', 'DemoCounty','user', null, null);
...
'Academic Advisor', '555-555-1234', 'sample@sample.com', 'Coach', '', '', 0, 0, 0,'', '', '');
...
INSERT INTO person_education_goal(
            ...
            course_work_weekly_hours_name, registration_load_name, anticipated_graduation_date_term_code)
    VALUES ('$(TASKID2)', '$(YEAR3)-09-13 09:22:00.092', '$(YEAR3)-09-13 09:22:00.092', '$(COACHID)', '$(COACHID)', '1',
            'Having Fun', null, 0, '78b54da7-fb19-4092-bb44-f60485678d6b', null, 'Computer Science', 0, 0, 0, 0, 
		null, null, null);
...
'55555', NULL, '$(PROGRESSINGSTUDENT2)',1, '$(YEAR1)-08-20', '$(YEAR1)-08-20', '$(COACHID)', 
    '$(COACHID)', '1', '$(TASKID2)', '$(TASKID2)', '$(TASKID2)', 'Patricia has strengths in writing, math, and work ethic.', '$(COACHID)', 1, 
    'FA$(YEAR1)', '$(YEAR1)', '$(YEAR1)-09-10 09:22:00.091', 
...
'Keep up the great work!', 0, 0, 0,'AS then Transfer to State U', '', 
...
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT142', 'AUMT-142', 'Automotive Engine Repair', ' ', 'SP2014', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT144', 'AUMT-144', 'Automotive Heating and Air Conditioning', ' ', 'SP2014', 4.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT241', 'AUMT-241', 'Automotive Engine Performance Analysis', ' ', 'SU2014', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'ENG101', 'ENG-101', 'English Composition I', ' ', 'SU2014', 3.00, 0, 2, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'),
 '$(TASKID3)', 'AUMT248', 'AUMT-248', 'Automotive Automatic Transmissions and Transaxle I', ' ', 'FA2014', 4.00, 0, 0, '', '', 0, NULL);
...
'  Course: HST234 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 1, '', '', 0, '9a07ced6-7b3a-4926-8a88-ba23f998fc46');
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT243', 'AUMT-243', 'Automotive Electronics', ' ', 'WN2014', 3.00, 0, 0, '', '', 0, NULL);
...
'  Course: MAT407 is not currently offered in the selected term.', 'WN2014', 3.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'ENG102', 'ENG-102', 'English Composition II', ' ', 'WN2014', 3.00, 0, 2, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT246', 'AUMT-246', 'Automotive Drive Train and Axles', ' ', 'SP2015', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT249', 'AUMT-249', 'Automotive Automatic Transmission and Transaxle II', ' ', 'SP2015', 4.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854',
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT146', 'AUMT-146', 'Automotive Suspension and Steering Systems', ' ', 'SU2015', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854',
 '$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'),
 '$(TASKID3)', 'AUMT243', 'AUMT-243', 'Automotive Electronics', ' ', 'SU2015', 3.00, 0, 1, '', '', 0, NULL);
...
'  Course: GEO172 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 1, '', '', 0, '3122e73b-dd86-4f23-af05-22c2abd93414');
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854',
 '$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'),
 '$(TASKID3)', 'AUMT251', 'AUMT-251', 'Automotive Service', ' ', 'WN2015', 4.00, 0, 0, '', '', 0, NULL);
...
' Course: MAT150 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 0, '', '', 0, NULL);
...
' Course: ENG101 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 1, '', '', 0, NULL);
...
' Course: CST101 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 2, '', '', 0, NULL);
...
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(NEWSTUDENT1)'), 
'$(TASKID1)', 'HST201', 'HST-201', 'U.S. History I', ' Course: HST201 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 3, '', '', 0, NULL);
...
' Course: PHL177 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 4, '', '', 0, NULL);
...
' Course: ENG102 is not currently offered in the selected term.', 'SP2014', 3.00, 0, 1, '', '', 0, NULL);
...
' Course: HST202 is not currently offered in the selected term.', 'SP2014', 3.00, 0, 2, '', '', 0, NULL);
...
' Course: CST102 is not currently offered in the selected term.', 'SP2014', 3.00, 0, 3, '', '', 0, NULL);
...
'ENG-205', 'English - Oral Communication', '    Course: ENG205 is not currently offered in the selected term.
 Course: ENG205 is not currently offered in the selected term.', 'SP2014', 3.00, 0, 4, '', '', 0, NULL);
...
'Technical and Business Writing', ' Course: ENG202 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 0, '', '', 0, NULL);
...
'Fundamentals of Networking Technologies', ' Course: CST130 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 1, '', '', 0, NULL);
...
'Object Oriented Programming', ' Course: CST230 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 2, '', '', 0, NULL);
...
'Introduction to C# Programming', ' Course: CST250 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 3, '', '', 0, NULL);
...
'Database Programming - Oracle', ' Course: CST201 is not currently offered in the selected term.', 'FA2014', 3.00, 0, 4, '', '', 0, NULL);
...
'Personal Computer Hardware', ' Course: CST270 is not currently offered in the selected term.', 'SP2015', 4.00, 0, 0, '', '', 0, NULL);
...
' Course: CST262 is not currently offered in the selected term.', 'SP2015', 3.00, 0, 1, '', '', 0, NULL);
...
'SP2015', 3.00, 0, 3, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'SP2015', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(NEWSTUDENT1)'), '$(TASKID1)', 'CST245', 'CST-245',
 ...
 Introduces a variety of software used by analysts and designers.', 'FA2015', 3.00, 0, 0, '', '', 0, NULL);
...
' Course: CST363 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 2, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
' Course: GEO196 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 3, '', '', 0, '3122e73b-dd86-4f23-af05-22c2abd93414');
...
' Course: CST220 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'Integrative Computing', ' Course: CST103 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'English Composition I', '  Course: ENG101 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 1, '', '', 0, NULL);
...
'CST-101', 'Programming Fundamentals I', '  Course: CST101 is not currently offered in the selected term.', 'FA$(YEAR3)', 3.00, 0, 2, '', '', 0, NULL);
...
'MAT-150', 'Mathematics for Business and Economics', ' ', 'SP2014', 3.00, 0, 0, '', '', 0, NULL);
...
'HST-201', 'U.S. History I', ' ', 'SP2014', 3.00, 0, 3, '', '', 0, NULL);
...
'$(TASKID2)', 'ENG102', 'ENG-102', 'English Composition II', ' ', 'SP2014', 3.00, 0, 1, '', '', 0, NULL);
...
'Programming Fundamentals II', ' ', 'SP2014', 3.00, 0, 3, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.543', '$(YEAR3)-09-13 13:27:34.543', '$(COACHID)', 
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'HST202', 'HST-202', 'U.S. History II', ' ', 'FA2014', 3.00, 0, 2, '', '', 0, NULL);
...
'$(TASKID2)', 'CST230', 'CST-230', 'Object Oriented Programming', ' ', 'FA2014', 3.00, 0, 2, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'ENG205', 'ENG-205', 'English - Oral Communication', ' ', 'WN2014', 3.00, 0, 0, '', '', 0, NULL);
...
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'ENG202', 'ENG-202', 'Technical and Business Writing', ' ', 'SP2015', 3.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'CST130', 'CST-130', 'Fundamentals of Networking Technologies', ' ', 'SP2015', 3.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'CST250', 'CST-250', 'Introduction to C# Programming', ' ', 'SP2015', 3.00, 0, 3, '', '', 0, NULL);
...
'  Course: CST178 is not currently offered in the selected term.', 'SP2015', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'CST-262', 'UNIX Operating System', ' ', 'SP2015', 3.00, 0, 1, '', '', 0, NULL);
...
'CST-201', 'Database Programming - Oracle', ' ', 'SU2015', 3.00, 0, 0, '', '', 0, NULL);
...
'CST-270', 'Personal Computer Hardware', ' ', 'FA2015', 4.00, 0, 0, '', '', 0, NULL);
...
'FA2015', 3.00, 0, 3, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'  Course: CST311 is not currently offered in the selected term.', 'FA2015', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'System Analysis and Design', ' ', 'FA2015', 3.00, 0, 0, '', '', 0, NULL);
...
'English - Oral Communication', ' ', 'WN2015', 3.00, 0, 0, '', '', 0, NULL);
...
'SP2016', 3.00, 0, 2, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'SP2016', 3.00, 0, 3, '', '', 0, '3122e73b-dd86-4f23-af05-22c2abd93414');
...
'Enterprise Computing', '  Course: CST220 is not currently offered in the selected term.', 'SP2016', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'Integrative Computing', '  Course: CST103 is not currently offered in the selected term.', 'SP2016', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');

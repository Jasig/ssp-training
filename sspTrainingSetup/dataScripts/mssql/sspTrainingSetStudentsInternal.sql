...
INSERT INTO strength(id, name, description, created_date, modified_date, created_by, modified_by, confidentiality_level_id, object_status, person_id)
VALUES ((SELECT generateUUID()), 'Primary Strength', 'Patricia has strengths in writing, math, and work ethic.', '$(YEAR1)-08-20', '$(YEAR1)-08-20', '$(TASKID2)','$(TASKID2)', 'b3d077a7-4055-0510-7967-4a09f93a0357', '1', (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'));
...
VALUES ((SELECT generateUUID()), '$(YEAR3)-09-05 14:53:22.853', '$(YEAR3)-09-05 14:53:22.853', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'CRIJ130', 'CRIJ-130', 'Introduction To Criminal Justice', 
' ', 'FA$(YEAR2)', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT generateUUID()), '$(YEAR3)-09-05 14:53:22.853', '$(YEAR3)-09-05 14:53:22.853', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'MAT183', 'MAT-183', 'Survey Mathematics', 
' ', 'SP$(YEAR3)', 4.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'AUMT245', 'AUMT-245', 'Automotive Alternative Fuels', ' ', 'SP$(YEAR4)', 4.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-05 14:53:22.854', '$(YEAR3)-09-05 14:53:22.854', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(STRUGGLINGSTUDENT3)'), 
'$(TASKID3)', 'MAT183', 'MAT-183', 'Survey of Mathematics', ' ', 'SP$(YEAR5)', 4.00, 0, 0, '', '', 0, NULL);
...
' Course: ENG102 is not currently offered in the selected term.', 'SP$(YEAR4)', 3.00, 0, 1, '', '', 0, NULL);
...
' Course: HST202 is not currently offered in the selected term.', 'SP$(YEAR4)', 3.00, 0, 2, '', '', 0, NULL);
...
' Course: CST102 is not currently offered in the selected term.', 'SP$(YEAR4)', 3.00, 0, 3, '', '', 0, NULL);
...
'ENG-205', 'English - Oral Communication', '    Course: ENG205 is not currently offered in the selected term.
 Course: ENG205 is not currently offered in the selected term.', 'SP$(YEAR4)', 3.00, 0, 4, '', '', 0, NULL);
...
'Technical and Business Writing', ' Course: ENG202 is not currently offered in the selected term.', 'FA$(YEAR4)', 3.00, 0, 0, '', '', 0, NULL);
...
'Fundamentals of Networking Technologies', ' Course: CST130 is not currently offered in the selected term.', 'FA$(YEAR4)', 3.00, 0, 1, '', '', 0, NULL);
...
'Personal Computer Hardware', ' Course: CST270 is not currently offered in the selected term.', 'SP$(YEAR5)', 4.00, 0, 0, '', '', 0, NULL);
...
' Course: CST262 is not currently offered in the selected term.', 'SP$(YEAR5)', 3.00, 0, 1, '', '', 0, NULL);
...
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(NEWSTUDENT1)'), '$(TASKID1)', 'CST245', 'CST-245',
 ...
 Introduces a variety of software used by analysts and designers.', 'FA$(YEAR5)', 3.00, 0, 0, '', '', 0, NULL);
...
' Course: CST363 is not currently offered in the selected term.', 'FA$(YEAR5)', 3.00, 0, 2, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
' Course: CST220 is not currently offered in the selected term.', 'FA$(YEAR5)', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'Integrative Computing', ' Course: CST103 is not currently offered in the selected term.', 'FA$(YEAR5)', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
INSERT INTO map_plan_course (id, created_date, modified_date, created_by, modified_by, object_status, 
            ...
            course_description, term_code, credit_hours, is_dev, order_in_term, 
            contact_notes, student_notes, is_important, elective_id) 
VALUES ((SELECT generateUUID()), 'YEAR3-09-13 13:27:34.543', 'YEAR3-09-13 13:27:34.543', '$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), '$(TASKID2)', 'CST230', 'CST-230', 'Object Orientated Programming', ' ', 'FA$(YEAR3)', 3.00, 0, 1, '', '', 0, NULL);
...
'CST-245', 'System Analysis and Design', ' ', 'FA$(YEAR3)', 3.00, 0, 2, '', '', 0, NULL);
...
'MAT-150', 'Mathematics for Business and Economics', ' ', 'SP$(YEAR4)', 3.00, 0, 0, '', '', 0, NULL);
...
'HST-201', 'U.S. History I', ' ', 'SP$(YEAR4)', 3.00, 0, 3, '', '', 0, NULL);
...
'$(TASKID2)', 'ENG102', 'ENG-102', 'English Composition II', ' ', 'SP$(YEAR4)', 3.00, 0, 1, '', '', 0, NULL);
...
'Programming Fundamentals II', ' ', 'SP$(YEAR4)', 3.00, 0, 3, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.543', '$(YEAR3)-09-13 13:27:34.543', '$(COACHID)', 
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'HST202', 'HST-202', 'U.S. History II', ' ', 'FA$(YEAR4)', 3.00, 0, 2, '', '', 0, NULL);
...
'$(TASKID2)', 'CST230', 'CST-230', 'Object Oriented Programming', ' ', 'FA$(YEAR4)', 3.00, 0, 2, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'ENG205', 'ENG-205', 'English - Oral Communication', ' ', 'WN$(YEAR4)', 3.00, 0, 0, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'CST130', 'CST-130', 'Fundamentals of Networking Technologies', ' ', 'SP$(YEAR5)', 3.00, 0, 1, '', '', 0, NULL);
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', 
'$(COACHID)', '$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), 
'$(TASKID2)', 'CST250', 'CST-250', 'Introduction to C# Programming', ' ', 'SP$(YEAR5)', 3.00, 0, 3, '', '', 0, NULL);
...
'  Course: CST178 is not currently offered in the selected term.', 'SP$(YEAR5)', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
VALUES ((SELECT NEWID()), '$(YEAR3)-09-13 13:27:34.544', '$(YEAR3)-09-13 13:27:34.544', '$(COACHID)', 
'$(COACHID)', 1, (SELECT id FROM person WHERE school_id = '$(PROGRESSINGSTUDENT2)'), '$(TASKID2)', 'CST262', 
'CST-262', 'UNIX Operating System', ' ', 'SP$(YEAR5)', 3.00, 0, 1, '', '', 0, NULL);
...
'CST-201', 'Database Programming - Oracle', ' ', 'SU$(YEAR5)', 3.00, 0, 0, '', '', 0, NULL);
...
'CST-270', 'Personal Computer Hardware', ' ', 'FA$(YEAR5)', 4.00, 0, 0, '', '', 0, NULL);
...
'  Course: CST311 is not currently offered in the selected term.', 'FA$(YEAR5)', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'System Analysis and Design', ' ', 'FA$(YEAR5)', 3.00, 0, 0, '', '', 0, NULL);
...
'Enterprise Computing', '  Course: CST220 is not currently offered in the selected term.', 'SP$(YEAR6)', 3.00, 0, 4, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'Integrative Computing', '  Course: CST103 is not currently offered in the selected term.', 'SP$(YEAR6)', 3.00, 0, 5, '', '', 0, '3bdda584-f7a2-4402-8863-4b5bd8273009');
...
'Computer Organization and Machine Language', ' ', 'SU$(YEAR6)', 3.00, 0, 0, '', '', 0, NULL);

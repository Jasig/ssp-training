...
if exist "%SQLFILEDIR%/%SETSTUDENTEXTERNALSQLFILE%" (
    ...
    rem Print To File Option  
        ...
        if "%6"== "1" (
	      rem  sqlcmd  -d ssp -i %SQLFILEDIR%\%SETSTUDENTEXTERNALSQLFILE% -v EXTERNALSYNC1="%1" EXTERNALSYNCFIRSTNAME="%2" EXTERNALSYNCMIDDLENAME="%3" EXTERNALSYNCLASTNAME="%4" YEAR3="%YEAR3%" YEAR2="%YEAR2%" COACHASSIGNED="%5" >> %OUTPUTFILE%
